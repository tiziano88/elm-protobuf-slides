...
Elm.Main.make = function (_elm) {
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([A2(_op["=>"],"padding","30px")
                                              ,A2(_op["=>"],"width","80vw")
                                              ,A2(_op["=>"],"font-family","\'Ubuntu\'")
                                              ,A2(_op["=>"],"font-size","1.5vw")]))]),
      _U.list([A3($Html.node,"script",_U.list([$Html$Attributes.src("./highlight/highlight.pack.js")]),_U.list([]))
              ...
              _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.style(_U.list([A2(_op["=>"],"height","40vw"),A2(_op["=>"],"overflow","auto")]))]),
